...
namespace Modules\Permission\Filament\Manager\Resources;
...
use Modules\Permission\Filament\Manager\Resources\RoleResource\Pages;
                        ...
                        Forms\Components\Tabs\Tab::make(__('filament-shield::filament-shield.pages'))
                            ...
                            ->schema([
                                Forms\Components\CheckboxList::make('pages_tab')
                                    ...
                                    ->searchable()
                                    ->live()
                                    ->afterStateHydrated(function (Component $component, $livewire, string $operation, ?Model $record, Forms\Set $set): void {
            ...
            $entities[] = Forms\Components\Section::make(FilamentShield::getLocalizedResourceLabel($entity['fqcn']))
                ...
                ->schema([
                    Forms\Components\CheckboxList::make($entity['resource'])
                        ...
                        ->live()
                        ->afterStateHydrated(function (Component $component, $livewire, string $operation, ?Model $record, Forms\Set $set) use ($entity): void {
                            static::setPermissionStateForRecordPermissions(
                                component: $component,
                                operation: $operation,
